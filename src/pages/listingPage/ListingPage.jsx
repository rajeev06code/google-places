...
const ListingPage = () => {
  ...
  const fetchList = async (cat, location, name) => {
    const response = await fetchListByCategory(cat, location, name);
  ...
  useEffect(() => {
    ...
    fetchList(category, userLocation, debouncedSearchTerm);
              ...
              <div className="w-full h-52 bg-gray-100 border-[0.2px] flex gap-4 rounded-lg overflow-hidden hover:scale-[1.01] transition-all duration-200 ease-out">
                ...
                <div className="w-8/12 h-full flex flex-col gap-1 p-4">
                  ...
                  <div className="mt-4 flex items-center gap-4">
                    <button className="bg-teal-400 hover:bg-teal-600 text-white font-bold py-1 px-4 rounded">View Detail</button>
